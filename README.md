...
Example output:
- [Example of signature probabilities (4 signatures)](./example/output_deciphered_4_signatures.txt)[/path/example/input](./example/output_deciphered_4_signatures.txt)
